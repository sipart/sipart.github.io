...
* This is a study guide for the new CCDE v2.1 written exam - [nrusso_ccie_ccde_evolving_tech_20dec2017.pdf](https://learningnetwork.cisco.com/docs/DOC-31004)
...
* Switches, Penguins and One Bad Cable - [Outbrain TechblogOutbrain Techblog](https://www.outbrain.com/techblog/2018/03/switches-penguins-one-bad-cable/)
...
* Understanding VLAN-Aware Bundle and VLAN-Based Service for EVPN - Technical Documentation - Support - Juniper Network(https://www.juniper.net/documentation/en_US/junos/topics/concept/evpn-vlan-services-overview-qfx-series.html)
...
* TinkerTry IT @ Home(https://tinkertry.com/)
...
* Designing for Data Center Migration and Application Mobility with Malcolm Booden - [Part 1](https://zigbits.tech/zndp-025-designing-for-data-center-migration-and-application-mobility-with-malcolm-booden-part-1/) - zigbits podcast - 1 hr 23 mins
...
* [Winfile](https://github.com/Microsoft/winfile/releases) - that old Windows file mamager back from the dead and open sourced
