...
* Understanding [High Availability Features](https://www.juniper.net/documentation/en_US/junos/information-products/pathway-pages/config-guide-high-availability/high-availability.html) - i.e. Graceful Routing Engine Switchover (GRES) and Non Stop_routing (NSR)
