...
[Ansilbe Tower](https://www.ansible.com/tower) exisits where an organisation would like to pay for a GUI based controller for many playbooks and users.

An open source GUI controller also exists called [Semaphore](https://github.com/ansible-semaphore/semaphore). 
