...
* AWS re:Invent [Breakout Sessions](https://reinventvideos.com/){:target="_blank"} - a lot of videos!
    ...
    How long is it before AWS (and other cloud providers) create a router, campus switch (see DENT above) and AP that leverage's    cloud management and AI for the enterprise like Mist/Meraki – and couple this up with this local cloud-in-a-rack and your existing cloud based services? And drop ship this enterprise kit same day from fulfillment warehouses for new kit and replacements? As long as the delivery man doesn’t throw it over the company fence or leave it in the skip when no one is in ;-)
