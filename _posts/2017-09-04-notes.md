...
Ansible have just (on the 7th Sept' 2017) [open sourced](https://www.jeffgeerling.com/blog/2017/ansible-open-sources-ansible-tower-awx) an upstream version of Ansible Tower and [it's here and it's called AWX](https://github.com/ansible/awx). Great way to try Tower or an organisation to maintain the code and support it themselves.
