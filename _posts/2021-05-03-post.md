...
* [Nautobot-Lab](https://www.networktocode.com/nautobot/){:target="_blank"} a Network Source of Truth and Network Automation Platform which is a forked version of Netbox. Get up and running quikcly using this docker container - [GitHub repo](https://github.com/nautobot/nautobot-lab){:target="_blank"}
...
## Devops
* Network Automation Ninja - VScode [Remote Host Developmen](https://networkautomation.ninja/p/blog/visual-studio-code-remote-host-development/){:target="_blank"}
...
* A Practical Guide to (Correctly){:target="_blank"} Troubleshooting with Traceroute. [Slidedeck PDF](https://t.co/C6VUWPp53d){:target="_blank"}
...
* Why (and How){:target="_blank"} Network Engineers Should Start #100DaysofCode - [Carpe DMVPN](http://carpe-dmvpn.com/2021/03/04/why-and-how-network-engineers-should-start-100daysofcode/){:target="_blank"}
...
* Visualising BGP-LS Tables (Python, GoBGP, gRPC, NetworkX){:target="_blank"} – [HB's Professional Blog](https://hbristoweu.wordpress.com/2021/01/13/visualising-bgp-ls-tables-python-gobgp-grpc-networkx/){:target="_blank"}
...
* Watch "Installing NetBox 10 minutes! on [YouTube](https://youtu.be/uHMXZpXpDvc){:target="_blank"} - 15 mins - nice short video that touches upon proxmox, containers (and nesting){:target="_blank"}, docker compose and netbox
...
* Space Networking visualised - Sat [Tracker](https://platform.leolabs.space/visualizations/leo){:target="_blank"}
