...
* Read it, then try it - (free!){:target="_blank"} with Juniper vLabs - [J-Net Community](https://forums.juniper.net/t5/BLOG-Information-Experience-iX/Read-it-then-try-it-with-Juniper-vLabs/ba-p/333445){:target="_blank"}
...
* JUNOS RPM: TESTING YOUR JUNIPER NETWORK WITH REAL-TIME PERFORMANCE MONITORS – [NETWORK FUN-TIMES](https://www.networkfuntimes.com/junos-rpm-testing-your-juniper-network-with-real-time-performance-monitors/){:target="_blank"}
...
* What is EVPN-VXLAN in an enterprise network? - [Juniper Networks](https://www.juniper.net/us/en/products-services/what-is/evpn-vxlan/#__prclt=6W2BQSl4){:target="_blank"}
...
* Watch "Hackathon Recap" on [YouTube](https://youtu.be/5pE8EFdEVlg){:target="_blank"} - 
...
* TextFSM is a Python module that implements a template based state machine for [parsing semi-formatted text](https://github.com/google/textfsm/wiki/TextFSM){:target="_blank"}
...
* Clouds in the sea! Microsoft subsea datacenters - [Project Natick Phase 2](https://natick.research.microsoft.com/){:target="_blank"} - with fishy webcams :-){:target="_blank"}
...
* speedscope - Interactive Flamegraph Explorer - (No idea but this sounds cool!){:target="_blank"}[http://jamie-wong.com/post/speedscope/]

* This is Windows 95, running in an Electron app. Yes, it's the full thing. He is sorry :-){:target="_blank"} [felixrieseberg/windows95](https://github.com/felixrieseberg/windows95/releases){:target="_blank"}
