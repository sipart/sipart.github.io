...
* Watch "The History of Unix, Rob Pike" on [YouTube](https://youtu.be/_2NI6t2r_Hs) - 1 hr
* Linux Performance [Observability Tools!](http://www.brendangregg.com/linuxperf.html) 
* Using Reboot Module in Ansible 2.7 - [ameen.io](http://ameen.io/en/blog/2018/10/using-reboot-module-in-ansible-2-7/)
* GNU nano 3.0 released with faster file reads, new shortcuts - [Packt Hub](https://hub.packtpub.com/gnu-nano-3-0-released-with-faster-file-reads-new-shortcuts-and-usability-improvements/)
* gbt: Highly configurable [prompt builder for Bash and ZSH](https://github.com/jtyr/gbt) written in Go
* Network Reliability Engineering - How NRE Labs Implements ["Curriculum-as-Code"](https://networkreliability.engineering/2018/11/how-nre-labs-implements-curriculum-as-code/)
* Yahoo Developer Network — Open-Sourcing Panoptes, Oath’s [distributed network...](https://yahoodevelopers.tumblr.com/post/17699833943/open-sourcing-panoptes-oaths-distributed-network)
* Jon Williams / Deploying Anycast DNS using [OpenBSD and BGP](https://jonwillia.ms/2018/09/23/anycast-dns-openbsd)
...
* Large-scale network simulations in Kubernetes - [Part 1](https://networkop.co.uk/post/2018-11-k8s-topo-p1/) and [Part 2](https://networkop.co.uk/post/2018-11-k8s-topo-p2/) - Network topology orchestration by [networkop](https://networkop.co.uk/)
* Run your favourite virtual routers in docker for convenient labbing, development and testing. VRnetLAB - [GitHub](https://github.com/plajjan/vrnetlab/blob/master/README.md)
* mrlesmithjr - [vagrant-box-templates](https://github.com/mrlesmithjr/vagrant-box-templates)
* Building A Network Automation Lab using [EVE-NG](http://www.eve-ng.net/) - [Lab Time Tutorial](https://www.lab-time.it/2018/09/22/building-a-network-automation-lab/) 
...
* Day One book: MPLS Up and Running with Junos - [J-Net Community](https://forums.juniper.net/t5/Day-One-Books/Day-One-MPLS-Up-and-Running-with-Junos/ba-p/411686)
* Day One book: Juniper Ambassadors’ Cookbook for 2018 - [J-Net Community](https://forums.juniper.net/t5/Day-One-Books/Day-One-Ambassadors-Cookbook-2018/ba-p/345580)
* Configuring an EVPN-VXLAN Fabric for a Campus Network - [TechLibrary](https://www.juniper.net/documentation/en_US/release-independent/nce/information-products/pathway-pages/nce/nce-168-evpn-vxlan-campus.html)
...
* Lessons in JUNOS Troubleshooting - Fising a LAN with a Weird Problem – [NETWORK FUN-TIMES](https://www.networkfuntimes.com/lessons-in-junos-troubleshooting-fixing-a-lan-with-a-weird-problem/)
* Juniper [EngNet](https://eng.juniper.net/site/global/home/index.gsp) - Junipers Cisco [DevNet](https://developer.cisco.com/)
* Moving LSPs Between INET.3 and INET.0 on a Juniper router – [NETWORK FUN-TIMES](https://www.networkfuntimes.com/moving-lsps-between-inet-3-and-inet-0-on-a-juniper-router/)
* JUNOS Routers: What Does The INET.3 Table Actually Do? – [NETWORK FUN-TIMES](https://www.networkfuntimes.com/junos-routers-what-does-the-inet-3-table-actually-do/)
* PacketFail.Net - JunOS FBF, Forwarding Instances, and [rib-group imports](http://www.packetfail.net/junos-fbf-forwarding-instances-and-rib-group-imports/)
* Multicast Protocols Feature Guide - [TechLibrary](https://www.juniper.net/documentation/en_US/junos/information-products/pathway-pages/config-guide-multicast/config-guide-multicast.html)
* Juniper QFX5110 - VMware NSX ESG - BGP Route Policy – [DAN HEARTY](https://danhearty.wordpress.com/2018/09/21/juniper-qfx5110-vmware-nsx-esg-bgp-route-policy/)
* VLAN manipulation/translation on [Juniper MX series routers](http://phil.lavin.me.uk/2016/10/vlan-manipulationtranslation-on-juniper-mx-series-routers/)
* Watch "History of BGP - Jeff Haas" - Juniper Networks Mr BGP :-)  - NLNOG 2018" on [YouTube](https://youtu.be/iPUBwXk4iEk) - 41 mins
...
* An Informal Guide to the Engines of Packet Forwarding - [J-Net Community](https://forums.juniper.net/t5/Routing/An-Informal-Guide-to-the-Engines-of-Packet-Forwarding/ta-p/401192)
...
* How To Kill Your [Tech Industry](https://logicmag.io/05-how-to-kill-your-tech-industry/) - a long but worthwhile read with mentions of the birth and starvation of ICL
