...
* Wherever you a perpetrator, a beneficiary or a victim of the oft common restructures then this is worth a read - Kill the restructure by [The IT Skeptic](http://www.itskeptic.org/content/kill-restructure){:target="_blank"} with some extra comment from the [Packet Pushers](https://packetpushers.net/kill-the-restructure-the-it-skeptic/){:target="_blank"}
