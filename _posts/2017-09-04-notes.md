...
The below was completed on a bare metal server install of EVE-NG (as EVE-NG is built upon Ubuntu 16.04). So all the below is pretty standard Linux/Ansible configuration.
