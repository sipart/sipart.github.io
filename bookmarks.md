...
* Car Cost [Calculators](https://carcosttool.com/){:target="_blank"}
...
* [Microsoft Visual Studio Code](https://code.visualstudio.com/){:target="_blank"} - free
...
* [eighthlayer](http://blog.eighthlayer.io/){:target="_blank"} - Behind the Socket
