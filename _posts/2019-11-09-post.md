...
* Wherever you a perpetrator, a beneficiary or a victim then comment on the oft common restructures are worthy of comments - read Kill the restructure by [The IT Skeptic](http://www.itskeptic.org/content/kill-restructure){:target="_blank"} wtih some extra comment from the [Packet Pushers](https://packetpushers.net/kill-the-restructure-the-it-skeptic/){:target="_blank"}
