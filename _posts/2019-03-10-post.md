...
* The rather exensive and overwhelming GNU/Linux Distributions [Timeline](https://upload.wikimedia.org/wikipedia/commons/1/1b/Linux_Distribution_Timeline.svg){:target="_blank"}
...
* Play with Kubernetes - [sandbox](https://training.play-with-kubernetes.com/){:target="_blank"}
