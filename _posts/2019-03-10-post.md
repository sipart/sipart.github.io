...
* Tiny, lightning fast, [feature-packed file manager](https://github.com/jarun/nnn){:target="_blank"}
...
* Upstream open source Ansible Tower [AWX-docker](https://github.com/geerlingguy/awx-container){:target="_blank"} - the fastest way to try it
