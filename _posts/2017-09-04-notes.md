...
As you can imagine Ansible (which is a product if [RedHat](https://www.redhat.com/en/technologies/management/ansible)) has extensive documentation and it can be found [here](http://docs.ansible.com/) - when getting more serious about Ansible then getting your file structure correct and ready for scaling up will reap dividends - check out this [Best Practice guide](http://docs.ansible.com/ansible/latest/playbooks_best_practices.html).
