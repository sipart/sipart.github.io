...
Additional elements are the devices outside the DC fabirc - the ZTP_DHCP is acting as the REDIS device in the NETQ setup below. The ztp-net and cumulus_ztp_test devices are not used in this post.
