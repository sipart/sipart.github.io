...
* Watch "Visual Studio Code Tips and Tricks – now with… (join us to find out){:target="_blank"} - BRK3022" on [YouTube](https://youtu.be/tnSnVlbKtMk){:target="_blank"} - 1 hr
...
* MPLS Fun in the Lab - Building a MPLS L3VPN Unicast and Multicast Cloud [(6 Part Blog Series){:target="_blank"}](https://www.networkingwithfish.com/fun-in-the-lab-building-a-mpls-l3vpn-unicast-and-mcast-cloud-overview/){:target="_blank"}
