...
* MTU settings on Junos & IOS - [Part 1,](http://matt.dinham.net/mtu-settings-on-junos-ios-part-1/){:target="_blank"} [Part2](http://matt.dinham.net/mtu-junos-vs-ios-part2-with-ospf/){:target="_blank"} and [Part 3](http://matt.dinham.net/mtu-settings-on-junos-ios-part-3-with-rsvp-mpls802-1q/){:target="_blank"}- Matt's Blog
...
* Packet loss [telemetry](https://github.com/ymitsos/packetloss-telemetry){:target="_blank"}
