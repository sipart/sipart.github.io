...
* Network Importer [GitHub repo](https://github.com/networktocode/network-importer){:target="_blank"} and [PyPI page](https://pypi.org/project/network-importer/){:target="_blank"}
...
## Cloud
* With the new Managed Grafana service AWS ups its open source game - [ZDNet](https://www.zdnet.com/google-amp/article/with-new-managed-grafana-service-aws-ups-its-open-source-game/){:target="_blank"}
...
* VPC Reachability Analyzer - [AWS News Blog](https://aws.amazon.com/blogs/aws/new-vpc-insights-analyzes-reachability-and-visibility-in-vpcs/){:target="_blank"}
* Use Amazon EC2 Mac Instances to Build & Test macOS, iOS, ipadOS, tvOS, and watchOS Apps - [AWS News Blog](https://aws.amazon.com/blogs/aws/new-use-mac-instances-to-build-test-macos-ios-ipados-tvos-and-watchos-apps/){:target="_blank"}
...
* Tweet from [@EVE_NG_TEAM](https://twitter.com/EVE_NG_TEAM){:target="_blank"} - Here we are :-) an SDWAN lab for beginners with book for EVE Pro and Community - [Viptela Lab files on mega.nz](https://t.co/Y8zoxQfihS){:target="_blank"}
...
* Running services like SSH, nginx, etc. on Windows Subsystem for Linux (WSL1) on boot – [A nice guy's view on life](https://jon.sprig.gs/blog/post/2007){:target="_blank"}
...
## Wireless
* Quadrature Amplitude Modulation (QAM) - [ni.com](https://www.ni.com/en-gb/innovations/white-papers/06/quadrature-amplitude-modulation--qam-.html){:target="_blank"}
...
* Juniper MIST API resources
    ...
    * Example API [Python Library](https://github.com/tmunzer/mistsystems){:target="_blank"}
...
* EMANIM wave lab (ElectroMAgNetic waves in vacuum and In Matter) [demo](https://emanim.szialab.org/index.html){:target="_blank"}
    * Szilágyi, András (2019): "EMANIM: Interactive visualization of electromagnetic waves".
