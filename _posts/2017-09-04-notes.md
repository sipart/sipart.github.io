...
Another mention of the above issues in a Cumulus forum post - [Ansible not able to overwrite the file?](https://getsatisfaction.cumulusnetworks.com/cumulus/topics/ansible-not-able-to-overwrite-the-file) forum post.
