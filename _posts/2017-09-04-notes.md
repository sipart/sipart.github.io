...
[Ansible Tower](https://www.ansible.com/tower) exisits where an organisation would like to pay for a supported GUI based controller for many playbooks and users.

Ansilbe have just (on the 7th Sept' 2017) [open sourced](https://www.jeffgeerling.com/blog/2017/ansible-open-sources-ansible-tower-awx) an upstram version of Ansible Tower and [it's here and it's called AWX](https://github.com/ansible/awx). Great way to try Tower or an orgianistion to maintain the code and support it themselves.
