...
* Basic Linux Networking tips and tricks [part 1:](https://aboutnetworks.net/linux-networking-part-1/){:target="_blank"} the ip and nmcli commands and [part 2:](https://aboutnetworks.net/linux-networking-part-2/){:target="_blank"} the mtr command - [AboutNetworks.net](https://aboutnetworks.net/){:target="_blank"}
...
* NIPAP - the best open source IP address management in the [known universe](https://spritelink.github.io/NIPAP/docs/INSTALL.html#){:target="_blank"} - I perhaps think [NetBox](https://netbox.readthedocs.io/en/stable/){:target="_blank"} is though
* Princeton [IoT Inspector](https://iot-inspector.princeton.edu/){:target="_blank"} - Automatically discovers IoT devices and analyzes their network traffic
...
* Microsoft [Terminal](https://github.com/microsoft/terminal){:target="_blank"} - The new Windows Terminal, and the original Windows console host - all in the same place!
* rpki [validation tools](https://github.com/GEANT/rpki-validation-tools){:target="_blank"} - Ansible roles for deploying RPKI validators on Ubuntu 
...
* A Hands-on Guide to Multi-Tiered Firewall Changes with [Ansible and Batfish - Part 1, ](http://www.packetflow.co.uk/a-hands-on-guide-to-multi-tiered-firewall-changes-with-ansible-and-batfish-part-1/){:target="_blank"}[Part 2](https://www.packetflow.co.uk/a-hands-on-guide-to-multi-tiered-firewall-changes-with-ansible-and-batfish-part-2/){:target="_blank"} and [Part 3](https://www.packetflow.co.uk/a-hands-on-guide-to-multi-tiered-firewall-changes-with-ansible-and-batfish-part-3/){:target="_blank"}
...
* AWS Outposts by the Numbers - [A Far-Too-Deep Dive Into Pricing](https://medium.com/@ahl/aws-outposts-68e78592c7f8){:target="_blank"}
...
* Azure [Speed Test 2.0](https://azurespeedtest.azurewebsites.net/){:target="_blank"} - Measuring the latency from your web browser to the Blob Storage Service in each of the Microsoft Azure Data Centers
* [CloudPing.info](https://www.cloudping.info/){:target="_blank"} - Estimate the latency from your browser to each AWS™ region
* GCP [ping](http://www.gcping.com/){:target="_blank"} - Measure your latency to GCP regions
