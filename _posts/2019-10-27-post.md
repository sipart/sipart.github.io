...
* The Secret Life of Traceroute. Tweet from [@SYNbit](https://twitter.com/SYNbit/status/1165197862222913537){:target="_blank"} - The secret life of traceroute. There is more to (interpreting){:target="_blank"} traceroute than meets the eye. This [presentation-pdf](https://t.co/zwsf79neFQ){:target="_blank"} has a lot of good stuff in it
...
* Model Driven Network Configuration - The End (Of Templates){:target="_blank"} Is Near! - course assignment notes on [GitHub](https://github.com/ctopher78/network-automation-course/blob/master/Homework3/README.md){:target="_blank"}
